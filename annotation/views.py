...
def annotation_list(request):
    ...
    return render(request, "annotation/annotation_list.html", {"annotation": annotations})


def annotation_detail(request, pk):
    annotation = get_object_or_404(Annotation, pk=pk)
    return render(request, "annotation/annotation_detail.html", {"annotaiton": annotation})
